...
# Title: IRIS flower Classification using Scikit-Learn Generalised 
#        models: An example of Multi-Class Classification in Python 
...
def evaluateAlgorithm(train_X, test_X, train_Y, test_Y):
    ...
    # Algorithms are applied with default parameter settings    
    
    # 1. Logistic Regression:LogisticRegression()
    LR_ = LogisticRegression()
    model_List.append(('LR', 'Logistic Regression', LR_))
    
    # 2. Stochastic Gradient Descent (SGD):SGDClassifier()
    SGD_ = SGDClassifier()
    model_List.append(('SGD', 'Stochastic Gradient Descent', SGD_))
    
    # 3. Passive Aggresive Algorithm (PA):PassiveAggressiveClassifier()
    PA_ = PassiveAggressiveClassifier()
    model_List.append(('PA', 'Passive Aggresive', PA_))    
